...
// Calculadora.cpp: define los comportamientos de las clases para la aplicación.
//
...
// Construcción de CCalculadoraApp
...
// Único objeto CCalculadoraApp

CCalculadoraApp theApp;


// Inicialización de CCalculadoraApp
